...
- Deployment to Cloud Run (**orchestra**): Both the prod and the staging services of orchestra are deployed as Cloud Run services ([prod](https://console.cloud.google.com/run/detail/europe-west1/orchestra/metrics?project=gcp-project-saas) and [staging](https://console.cloud.google.com/run/detail/europe-west1/orchestra-staging/metrics?project=gcp-project-saas)). These builds are triggered when something is pushed to the `main` and `staging` branches, respectively. Triggers are defined as [Google Cloud Build Triggers](https://console.cloud.google.com/cloud-build/triggers;region=global?project=gcp-project-saas) (`unify-orchestra` and `unify-orchestra-staging`). These triggers pass the corresponding `cloudbuild` ([prod](../../cloudbuild.yaml) and [staging](../../cloudbuild_staging.yaml)) files to [Cloud Build](https://console.cloud.google.com/cloud-build/builds?project=gcp-project-saas).
