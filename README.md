...
The following infrastructure settings are configured directly in GCP (`gcp-project-saas`):
...
- **Cloud Scheduler**: All scheduler jobs in both `gcp-project-saas` and `gcp-project-runtime` include `Authorization` headers.
