...
supported_models = {
    ...
    "claude-3.7-sonnet": {
        "endpoint": "anthropic/claude-3-7-sonnet-20250219",
        "context_window": 200000,
    ...
    "claude-4-opus": {
        "endpoint": "anthropic/claude-opus-4-20250514",
        "context_window": 200000,
        "cost": {"prompt": 15, "completion": 75},
    },
    "claude-4.1-opus": {
        "endpoint": "anthropic/claude-opus-4-1-20250805",
        "context_window": 200000,
        "cost": {"prompt": 15, "completion": 75},
    },
    "claude-4.5-sonnet": {
        "endpoint": "anthropic/claude-sonnet-4-5-20250929",
        "context_window": 200000,
        "cost": {"prompt": 3, "completion": 15},
    },
}
