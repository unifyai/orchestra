...
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Test basic log retrieval with limit=1000 (max allowed)."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
#     params = {
#         "project": project,
...
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project
# ):
...
#         "context": repairs_context,
#         "sorting": json.dumps(
#             {"WorksOrderPriorityDescription": "descending", "WorksOrderStatusDescription": "ascending"}
#         ),
#         "limit": 500,
#     }
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_group_by_status(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Group logs by WorksOrderStatusDescription."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
...
#         "project": project,
#         "context": repairs_context,
#         "key": "WorksOrderStatusDescription",
#         "group_threshold": 10,
#     }

#     response = await timed_client.get("/v0/logs/groups", params=params, headers=HEADERS)
#     assert response.status_code == 200
#     data = response.json()
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_group_by_priority(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Group logs by WorksOrderPriorityDescription."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
...
#         "project": project,
#         "context": repairs_context,
#         "key": "WorksOrderPriorityDescription",
#         "group_threshold": 10,
#     }
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_group_by_operative(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Group logs by OperativeName (122 unique values)."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_group_by_first_time_fix(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_metric_count_first_time_fix(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Count metric on FirstTimeFix field."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
...
#         "/v0/logs/metric/count", params=params, headers=HEADERS
#     )
#     assert response.status_code == 200
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_metric_count_status(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Count metric on WorksOrderStatusDescription field."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
...
# @pytest.mark.usefixtures("large_repairs_dataset")
# @pytest.mark.performance
# async def test_metric_count_priority(
#     mode, timed_client, repairs_eav_project, repairs_jsonb_project, repairs_context
# ):
#     """Count metric on WorksOrderPriorityDescription field."""
#     project = await setup_mode(
#         timed_client, mode, repairs_eav_project, repairs_jsonb_project
#     )
