...
def create_phone_number(phone_country: str = "US", is_staging: bool = False):
    ...
    """
    voice_url = "https://us-central1-gcp-project-runtime.cloudfunctions.net/" + (
        "twilio-call-webhook" if not is_staging else "twilio-call-webhook-staging"
    )
    sms_url = "https://us-central1-gcp-project-runtime.cloudfunctions.net/" + (
...
def log_pre_hire_chat(assistant_id: str, messages: list, is_staging: bool = False):
    ...
    """
    webhook_url = (
        "https://us-central1-gcp-project-runtime.cloudfunctions.net/log-pre-hire-chats-webhook"
