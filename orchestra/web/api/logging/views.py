...
def log_query(
    ...
    query_body: str = Body(
        ...
        json_schema_extra={
            "example": """{"messages": [{"role": "system", "content": "You are an useful assistant"}, {"role": "user", "content": "Explain who Newton was."}], "model": "llama-3-8b-chat@aws-bedrock", "max_tokens": 100, "temperature": 0.5}"""
        },
    ),
