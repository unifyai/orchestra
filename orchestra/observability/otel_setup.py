"""OpenTelemetry setup helpers for orchestra.
...
def _create_tracer_provider() -> TracerProvider:
    ...
    def _add_processor(proc: SpanProcessor) -> None:
        if settings.otel_exclude_patterns:
            from orchestra.observability.filtering_span_processor import (
    ...
    if settings.log_enabled and settings.log_dir:
        try:
            from orchestra.observability.file_trace_exporter import FileSpanExporter
