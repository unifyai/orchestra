...
MY_COMPUTER_FRAMING = (
    ...
    "await primitives.computer.desktop.act('In the Save dialog now open, press "
    "Ctrl+L to open its location entry — do NOT touch the Name/filename "
    "field', verify=False); "
    "display(await primitives.computer.desktop.get_screenshot()); "
    "await primitives.computer.desktop.act('Type /Unity/Local/Outputs into the "
    "location entry that just opened and press Enter', verify=False); "
    "display(await primitives.computer.desktop.get_screenshot()); "
    ...
    "verify=False); "
    "display(await primitives.computer.desktop.get_screenshot()); "
    "await primitives.computer.desktop.act('In Thunar, press Ctrl+L to focus "
    "the location bar', verify=False); "
    "display(await primitives.computer.desktop.get_screenshot()); "
    "await primitives.computer.desktop.act('Type the saved image folder path "
    "(/Unity/Local/Outputs from 2a, or /Unity/Local/Downloads from 2b) into "
    "the location bar and press Enter', verify=False); "
    "display(await primitives.computer.desktop.get_screenshot()); "
