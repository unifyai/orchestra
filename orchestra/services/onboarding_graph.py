...
MY_COMPUTER_FRAMING = (
    ...
    "screenshot substep — the desktop is already ready when the demo starts; go "
    "straight into the visible work. "
...
def _my_computer_beat_event(step_id: str, title: str) -> OnboardingEventSpec:
    ...
    return OnboardingEventSpec(
        ...
        message=(
            ...
            "already usable) and tell them to click Show assistant screen. Drive five "
            ...
            "low-level click/type only as fallback; notify(...) before each major "
            "visual action. Never a terminal or shell xdg-open. After "
