...
Creates the 13 kernel tables registered by orchestra's model package.
...
def _kernel_tables():
    ...
    Importing core_models registers them on `orchestra.db.meta.meta`.
    """
