"""Async version of latest_benchmark_dao for use with AsyncSession."""
...
class AsyncLatestBenchmarkDAO:
    """Class for accessing latest_benchmark table."""

    def __init__(self, session: AsyncSession):
        self.session = session

    async def get_latest_benchmarks(self, endpoint_id, regime, region, seq_len):
        """
    ...
    async def get_benchmark_with_endpoints(self):
        """
