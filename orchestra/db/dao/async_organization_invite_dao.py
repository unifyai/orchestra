"""Async Data Access Object for OrganizationInvite model."""
import uuid
...
class AsyncOrganizationInviteDAO:
    ...
    async def delete_invite(self, invite: OrganizationInvite) -> None:
        """
    ...
    async def is_valid_for_acceptance(
        self,
        invite: OrganizationInvite,
    ) -> tuple[bool, str]:
        """
