"""Async version of context_dao for use with AsyncSession."""
...
class AsyncContextDAO:
    ...
    async def _validate_foreign_keys_config(
        self,
        project_id: int,
        context_name: str,
    ...
    async def _validate_simple_fk_reference(
        self,
        fk: Dict[str, Any],
        entries: Dict[str, Any],
        project_id: int,
    ...
    async def _validate_nested_fk_reference(
        self,
        fk: Dict[str, Any],
        entries: Dict[str, Any],
        project_id: int,
    ...
    async def batch_validate_foreign_key_references(
        self,
        project_id: int,
        context_id: int,
    ...
    #     context = (await self.session.execute(select(Context).filter_by(id=context_id))).scalars().one_or_none()
    #     if not context:
    #         return []
    #     context_name = context.name
    #
    ...
    async def _cascade_delete_jsonb(
        self,
        context_id: int,
        fk_column: str,
        old_value_json: str,
    ...
    async def _cascade_update_jsonb(
        self,
        context_id: int,
        fk_column: str,
        old_value_json: str,
    ...
    async def _cascade_update_batch(
        self,
        context_id: int,
        fk_column: str,
    ...
    async def _cascade_update_batch_jsonb(
        self,
        context_id: int,
        fk_column: str,
        old_values_json: List[str],
    ...
    async def _set_null_batch_jsonb(
        self,
        context_id: int,
        fk_column: str,
        old_values_json: List[str],
    ...
    async def _cascade_delete_nested_remove_elements(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _cascade_delete_nested(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _cascade_delete_nested_jsonb(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _cascade_delete_nested_remove_elements_jsonb(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _cascade_update_nested_batch(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _cascade_update_nested_batch_jsonb(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _set_null_nested_batch(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _set_null_nested_batch_jsonb(
        self,
        context_id: int,
        fk_path: str,
        path_segments: List,
    ...
    async def _remove_matching_array_elements(
        self,
        data: Any,
        path_segments: List,
    ...
    async def _object_contains_value(
        self,
        obj: Any,
        path_segments: List,
        values_to_check: set,
    ...
    async def _update_nested_value(
        self,
        data: Any,
        path_segments: List,
        old_values_set: set,
    ...
    async def delete(self, id: int) -> None:
        ...
        try:
            context = (
                (await self.session.execute(select(Context).filter_by(id=id)))
                .scalars()
                .one()
            )
            ...
            await self.session.flush()  # Ensure the context deletion cascades.
    ...
    async def add_logs(self, context_id: int, log_ids: List[int]) -> None:
    ...
    async def is_versioned(self, context_id: int) -> bool:
        context = (
            (await self.session.execute(select(Context).filter_by(id=context_id)))
            .scalars()
            .one_or_none()
    ...
    async def get_context_id(self, project_id: int, body):
        if body:
    ...
    async def check_for_duplicates(self, context_id: int, log_event_id: int) -> bool:
        """
    ...
    async def check_for_duplicates_subset(
        self,
        context_id: int,
        log_event_id: int,
    ...
    async def check_for_duplicates_subset_batch(
        self,
        context_id: int,
    ...
    async def check_for_duplicates_jsonb_batch(
        self,
        context_id: int,
        log_event_ids: List[int],
    ) -> List[int]:
    ...
    async def add_logs_copy(self, context_id: int, log_ids: List[int]) -> None:
        ...
        try:
            ...
            for original_log_id in log_ids:
                ...
                if new_logs:
                    ...
                    await self.session.flush()  # Get IDs for new logs
                ...
                if JSONLog is not None:
                    try:
                        ...
                        if new_json_logs:
                            ...
                            await self.session.flush()  # Get IDs for new JSONLogs
    ...
    async def rollback(self, context_id: int, commit_hash: str) -> None:
        """
    ...
    async def get_commit_history(self, context_id: int) -> List[dict]:
        """
    ...
    async def create_version_snapshot(
        ...
        await self.session.flush()  # Flush to get the context_version.id
    ...
    async def rollback_to_version(
        ...
        await self.session.execute(
            delete(LogEventContext).filter_by(context_id=context_id),
        )
    ...
    async def create_version_snapshot_jsonb(
        self,
        context: Context,
        commit_hash: str,
        commit_message: Optional[str] = None,
    ...
    async def rollback_to_version_jsonb(
        self,
        context_id: int,
        context_version_id: int,
    ) -> None:
