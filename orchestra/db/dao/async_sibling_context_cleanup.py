...
async def get_assistants_sibling_context_info(
    ...
    async def _add_sibling(log_id: int, ctx_id: int):
    ...
    async def _get_log_field_values(field_name: str) -> Dict[int, str]:
    ...
    async def _find_context_id(ctx_name: str) -> Optional[int]:
    ...
    async def _verify_logs_in_context(ctx_id: int, logs: List[int]) -> List[int]:
    ...
    async def _get_tier1_context_for_logs() -> Dict[int, str]:
    ...
    async def _parse_tier1_context(tier1_ctx: str) -> tuple:
