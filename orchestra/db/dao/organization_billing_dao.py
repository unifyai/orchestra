"""Data Access Object for organization billing operations."""
import decimal
import logging
...
class OrganizationBillingDAO:
    ...
    def has_direct_billing(self, organization_id: int) -> bool:
        """
    ...
    def get_credits(self, organization_id: int) -> decimal.Decimal:
        """
    ...
    def should_trigger_autorecharge(self, organization_id: int) -> bool:
        """
    ...
    def is_account_active(self, organization_id: int) -> bool:
        """
    ...
    def get_business_profile(self, organization_id: int) -> Optional[dict]:
        """
    ...
    def clear_delegated_billing(self, organization_id: int) -> bool:
        """
