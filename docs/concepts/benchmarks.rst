...
The main goal of the Hub is to allow you to use the endpoint (and model!) that better suits your use case.
This is not a trivial decision to make, and therefore it needs to be made based on data. That's why we have the goal of
benchmarking every single endpoint out there.
