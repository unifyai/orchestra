...
The telemetry for the orchestra can be accessed from here https://internal.example.com/
...
1. [`jaeger-collector`](https://console.cloud.google.com/run/detail/europe-west1/jaeger/metrics?project=gcp-project-saas)
2. [`jaeger-query`](https://console.cloud.google.com/run/detail/europe-west1/jaeger-query/metrics?project=gcp-project-saas)
3. [`elastic-search` cluster](https://console.cloud.google.com/kubernetes/clusters/details/europe-west1/elastic-search-cluster/details?project=gcp-project-saas)
...
Provides an interface for users to see traces. Accessible through https://internal.example.com/.
