...
def create_vm():
    ...
    initialize_params.disk_type = (
        "projects/gcp-project-saas/zones/europe-west1-b/diskTypes/pd-balanced"
    )
    boot_disk.initialize_params = initialize_params
    boot_disk.auto_delete = True
    boot_disk.boot = True

    project_id = "gcp-project-saas"
    zone = "europe-west1-b"
    ...
    accelerators = [
        compute_v1.AcceleratorConfig(
            accelerator_count=1,
            accelerator_type="projects/gcp-project-saas/zones/europe-west1-b/acceleratorTypes/nvidia-tesla-t4",
        ),
    ]
